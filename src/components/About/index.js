    ...
    <>
      <main>
        ...
        <div className="about-page-container">
          ...
          <p>
            The School of Code is an intensive learning environment. Our core
            stack is React, Node.js / Express, PostgreSQL, and testing with
            Jest. We have also used TypeScript, Docker, Next.js, Cypress, Auth0,
